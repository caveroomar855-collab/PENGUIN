                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${articulo.tipo.toUpperCase()}${articulo.talla != null && articulo.talla!.isNotEmpty ? " - Talla: ${articulo.talla}" : ""} - ${articulo.nombre}',
                                      style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.grey[700]),
                                    ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CheckboxListTile(
                    ...
                    subtitle: Text(
                        // Quitamos " - ${articulo.nombre}" de la cadena
                        '${articulo.tipo.toUpperCase()}${articulo.talla != null && articulo.talla!.isNotEmpty ? " - Talla: ${articulo.talla}" : ""}\nS/ ${articulo.precioVenta.toStringAsFixed(2)}'),
                  );
                },
              ),
            ),
